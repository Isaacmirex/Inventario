...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AjusteDetalleProducto", b =>
                {
                    b.Property<string>("AjusteDetalledet_id")
                        .HasColumnType("text");

                    b.Property<string>("Productoprod_id")
                        .HasColumnType("text");

                    b.HasKey("AjusteDetalledet_id", "Productoprod_id");

                    b.HasIndex("Productoprod_id");

                    b.ToTable("AjusteDetalleProducto");
                });
            ...
            modelBuilder.Entity("AjusteDetalleProducto", b =>
                {
                    b.HasOne("API_INVETARIO.EFCore.AjusteDetalle", null)
                        .WithMany()
                        .HasForeignKey("AjusteDetalledet_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("API_INVETARIO.EFCore.Producto", null)
                        .WithMany()
                        .HasForeignKey("Productoprod_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
